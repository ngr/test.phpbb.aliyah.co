...
# Lessons class
require $config_fc['path']['classes'] . 'lessons' . $config_fc['var']['phpEx'];
$GLOBALS['lessons'] = false;
...
$config_fc['robot']['ww']['count'] = 10; # Number of worst words (WW) for lesson
...
# Configuration of lessons class
$config_fc['lessons']['foo'] = true;
