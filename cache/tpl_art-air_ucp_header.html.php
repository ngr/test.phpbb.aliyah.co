...
<div id="tabs">
    <div class="dropdown-tabs">
        <a href="javascript:void(0);"><?php $_t_block1_count = (isset($this->_tpldata['t_block1'])) ? sizeof($this->_tpldata['t_block1']) : 0;if ($_t_block1_count) {for ($_t_block1_i = 0; $_t_block1_i < $_t_block1_count; ++$_t_block1_i){$_t_block1_val = &$this->_tpldata['t_block1'][$_t_block1_i]; if ($_t_block1_val['S_SELECTED']) {  echo $_t_block1_val['L_TITLE']; } }} ?></a>
        <ul>
    ...
    <div class="dropdown-tabs">
        <a href="javascript:void(0);">
            <?php $_t_block2_count = (isset($this->_tpldata['t_block2'])) ? sizeof($this->_tpldata['t_block2']) : 0;if ($_t_block2_count) {for ($_t_block2_i = 0; $_t_block2_i < $_t_block2_count; ++$_t_block2_i){$_t_block2_val = &$this->_tpldata['t_block2'][$_t_block2_i]; if ($_t_block2_val['S_SELECTED']) {  echo $_t_block2_val['L_TITLE']; } }} if ($this->_rootref['S_PRIVMSGS']) {  $_folder_count = (isset($this->_tpldata['folder'])) ? sizeof($this->_tpldata['folder']) : 0;if ($_folder_count) {for ($_folder_i = 0; $_folder_i < $_folder_count; ++$_folder_i){$_folder_val = &$this->_tpldata['folder'][$_folder_i]; if ($_folder_val['S_CUR_FOLDER']) {  echo $_folder_val['FOLDER_NAME']; } }} } ?>

        </a>
        <ul>
		<?php if ($this->_rootref['S_PRIVMSGS']) {  $_t_block2_count = (isset($this->_tpldata['t_block2'])) ? sizeof($this->_tpldata['t_block2']) : 0;if ($_t_block2_count) {for ($_t_block2_i = 0; $_t_block2_i < $_t_block2_count; ++$_t_block2_i){$_t_block2_val = &$this->_tpldata['t_block2'][$_t_block2_i]; if ($this->_rootref['S_PRIVMSGS'] && ! $_t_block2_val['S_LAST_ROW']) {  if ($_t_block2_val['S_SELECTED']) {  ?>
					...
					<?php } } }} $_folder_count = (isset($this->_tpldata['folder'])) ? sizeof($this->_tpldata['folder']) : 0;if ($_folder_count) {for ($_folder_i = 0; $_folder_i < $_folder_count; ++$_folder_i){$_folder_val = &$this->_tpldata['folder'][$_folder_i]; if ($_folder_val['S_CUR_FOLDER']) {  ?>
